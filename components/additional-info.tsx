  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
      <WobbleCard
        ...
        className="" 
      >
        <Link href={'https://github.com/RexanWONG/imagecrafter'} target="_blank" rel="noopener noreferrer">
            <div className="max-w-xs">
                <h2 className="text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
                    ImageCrafter is Open Source 
                </h2>
      ...
      <Link href={'https://x.com/rexan_wong/status/1840286290052538714'} target="_blank" rel="noopener noreferrer">
        <WobbleCard containerClassName="col-span-1 min-h-[300px]">
                ...
                <p className="mt-4 max-w-[26rem] text-left text-base/6 text-neutral-200">
                    Created a sick ImageCrafter design? Share it! Click on this box.
                </p>
        </WobbleCard>
      </Link>
    </div>
